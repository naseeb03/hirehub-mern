export const mockJobs = [
  ...
  },
  {
    ...
    benefits: "Flexible hours, Paid vacation, Professional growth programs.",
    status: "active",
  },
  {
    title: "HR Manager",
    ...
    location: "London, UK",
    type: "full-time",
    salary: "70,000 GBP/year",
    benefits: "Company car, Pension scheme, Team-building events.",
    status: "active",
  },
  {
    ...
    benefits: "Freelance options, Access to design tools, International projects.",
    status: "active",
  },
  {
    ...
    benefits: "Work from anywhere, Performance bonuses.",
    status: "active",
  },
];
